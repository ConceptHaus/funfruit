        ...
        .flex.flex-col.sm_flex-row.justify-around
            .block
                ...
                a(href="http://www.sgs.com/certifiedclients" target="_blank")
                    g-image.certification__img.object-contain.mx-auto.m-5(src="@/assets/images/SGS-FSSC 22000-round-TCL.jpg")
                g-image.certification__img.object-contain.mx-auto.m-5(src="@/assets/images/Logo FSSC 22000 versie_2015_def_.jpg")
            .block
