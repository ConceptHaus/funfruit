<template lang="pug">
    .container.my-8
        .flex.justify-around.flex-col(class="sm_flex-row")
            .block
                img.object-fit(src="@/assets/images/products/mango_enchilado/1.jpg", alt="alt")
            .block.w-full(class="sm_w-2/5")
                .bg-ui-green.pb-4.pt-12.px-4.sm_px-16
                    h2.product__title.text-white.text-3xl Mango Enchilado
                    p.text-white Cont. 550 g / 8 Piezas por caja / Vitrolero con tapa
                    ...
                    .flex.justify-around
                        .block
                            ...
                            ul
                                ...
                                li.text-white Proteínas (g)
                                li.text-white Carbohidratos totales (g)
                                li.text-white Azúcares (g)
